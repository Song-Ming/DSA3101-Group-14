...
##cluster 1 has highest rate of success for previous campaigns, while most of cluster 2 was not contacted
...
plt.tight_layout()
plt.show()
##Cluster 1 has higher proportion of student and retired population, thus this group may opt for low-risk financial products
##Both Cluster 0 and Cluster 2 has diverse job types, but cluster 2 has higher proportion of higher-paid jobs like entrepreneur, hence may be potentially targeted for future campaigns
...
##higher proportion of cluster 1 subscribed to term deposit, revealing their interests in more financial secure campaigns, while cluster 0 has higher proportion of engagement than cluster 2

#Cluster 0: Diverse job types. Moderate subscription to term deposits. Contacted less frequently, and response rate is low.
#Cluster 1: Relatively higher proportion of retired individuals and students, higher subscription to term deposits. Contacted recently and response to marketing campaign is high
#Cluster 2: Diverse job types with more high paying jobs. Lowest subsciption to term deposits. Most were never contacted for previous marketing campaigns.